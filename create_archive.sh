...
for pkgname in mingw-w64-binutils mingw-w64-headers mingw-w64-crt mingw-w64-winpthreads mingw-w64-gcc mingw-w64-lapack mingw-w64-cmake mingw-w64-libxml2 mingw-w64-libgnurx mingw-w64-dlfcn mingw-w64-gettext mingw-w64-termcap mingw-w64-libiconv mingw-w64-zlib mingw-w64-muparser mingw-w64-boost mingw-w64-qt4-debug mingw-w64-qscintilla mingw-w64-qwt5 mingw-w64-iistaskpanel
do
  echo "-- $pkgname"
