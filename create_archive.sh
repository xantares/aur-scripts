...
#mingw-w64-libzip mingw-w64-libpng mingw-w64-dbus mingw-w64-libjpeg-turbo mingw-w64-libtiff mingw-w64-openssl mingw-w64-expat mingw-w64-sqlite mingw-w64-qt4 mingw-w64-qscintilla-qt4 mingw-w64-qwt mingw-w64-iistaskpanel
do
  echo "-- $pkgname"
